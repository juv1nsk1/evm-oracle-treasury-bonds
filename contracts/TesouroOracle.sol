...
contract TesouroOracle is Titulos {
    ...
    function obterOfertas(string calldata _isin) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        return (titulo.dia, titulo.valorUltimaTransacao, titulo.valorMedio, titulo.volume, titulo.melhorOfertaCompra, titulo.melhorOfertaVenda, titulo.transacoesParaPF, titulo.transacoesParaPJ);
    }
